            ...
            <div id="margin">
                <div id="box3">
                    <div class="blogPost">
                        ...
                        <article class="artPost"><p>Hitori Gotoh est une jeune fille de nature solitaire ayant une grande passion pour la musique, en particulier la guitare. Sa
                                timidité et son isolement l'empêchent de parler normalement avec d'autres personnes et elle n'est pas vraiment douée pour se lier d'amitié avec ses
                                camarades.<br><br>
            ...
            <div id="margin">
                <div id="box3">
                    <div class="blogPost">
                        ...
                        <article class="artPost"><p>Naruto Uzumaki est un ninja du village de Konoha. Il devint le jinchûriki de Kyûbi le jour
                                de sa naissance ce qui lui valut d'être rejeté par la plupart des habitants de Konoha durant toute son enfance. Après avoir rejoint l'Équipe 7,
                                Naruto travailla dur pour obtenir la reconnaissance des villageois tout en poursuivant son rêve de devenir Hokage.
                                <br>
            ...
            <div id="margin">
                <div id="box3">
                    <div class="blogPost">
                        ...
                        <article class="artPost"><p>Lelouch vi Britannia est le protagoniste et antihéros de Code Geass. Il est âgé de 17 ans.
                                <br><br>
            ...
            <div id="margin">
                <div id="box3">
                    <div class="blogPost">
                        ...
                        <article class="artPost"><p>Eren Jäger est un membre du Bataillon d'exploration et le protagoniste, puis l'antagoniste principal de la série.
                                Il a vécu dans le District de Shiganshina avec ses parents et Mikasa Ackerman jusqu'à la chute du Mur Maria.
                                <br><br>
            ...
            <div id="margin">
                <div id="box3">
                    <div class="blogPost">
                        ...
                        <article class="artPost"><p>Izuku Midoriya ou Deku , également appelé par sa mère Izuku-Might, est le personnage principal du manga My Hero Academia.
                                Né Sans-Alter, il attirera l'attention d'All Might pour son héroïsme et deviendra l'héritier de son Alter : le One For All.
                                <br><br>
